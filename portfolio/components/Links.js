...
const Links = () => {
    return (
        <footer className='py-6 bg-body opacity-100'>
        <div className='container flex justify-center items-center mx-auto px-8 md:px-14 lg:px-24 w-full mb-12'>
            <div className='md:flex space-x-12 items-center'>
                
                <span className='invert hover:animate-bounce'>
                    <a href="https://github.com/nwsop" target="_blank">
                ...
                <span className='invert hover:animate-pulse'>
                    <a href="https://www.linkedin.com/in/nathaniel-sop-833867115" target="_blank">
